...
//  var fieldWidth  = 400
//  var fieldHeight = 200
//  val field = WH(400, 200)
//
//
//  case class Paddle(width: Int, height: Int, depth: Int, quality: Int, dirY: Int) {
//    val speed = 3
//  }
//
//  // ball variables
