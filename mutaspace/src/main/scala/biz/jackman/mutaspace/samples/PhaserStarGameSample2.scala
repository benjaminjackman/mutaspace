...
import biz.jackman.facades.phaser.Phaser.PhaserCallbacks
...
object PhaserStarGameSample2 {
  ...
  def start() {
    ...
    game = new Phaser.Game(800, 600, Phaser.AUTO, "", new PhaserStarGameSample2(() => game))
  }


}

class PhaserStarGameSample2(gameFn: () => Phaser.Game) extends PhaserCallbacks {
